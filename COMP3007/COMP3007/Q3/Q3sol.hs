...
eval Square = {- SOLN -} Square {- STUBWITH undefined -}

eval Add = {- SOLN -} Add {- STUBWITH undefined -}
...
evalApp Square e = {- SOLN -} evalPrimitive Square (eval e) {- STUBWITH undefined -}
evalApp Add e = {- SOLN -} evalPrimitive Add (eval e) {- STUBWITH undefined -}
evalApp (App Add v) e =
  {- SOLN -}
  let Const m = v
      Const n = eval e
...
evalPrimitive Square (Const n) = {- SOLN -} Const (n*n) {- STUBWITH undefined -}
evalPrimitive Add v = {- SOLN -} App Add v {- STUBWITH undefined -}
evalPrimitive f arg = 
...
deleteIf p [] =
  return []
deleteIf p (x:l) | p x = do
  outputLine (show x)
  deleteIf p l
deleteIf p (x:l) = do
  l' <- deleteIf p l
  return (x:l')  
{- STUBWITH deleteIf = undefined -}
